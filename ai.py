...
# 2️⃣ Kullanıcıları K-Means ile Gruplandır
...
# 5️⃣ OpenAI API entegrasyonu: Prompt oluşturma ve öneri çekme
...
# 6️⃣ /stats Endpoint: Günlük veriler, haftalık ilerleme ve çalışma raporu
